...
import { Upload, Film, X, Check, AlertCircle, GamepadIcon } from 'lucide-react';
...
const UploadPage = () => {
  ...
  const [uploadedFiles, setUploadedFiles] = useState<Video[]>([]);
  ...
  const previousHighlights = [
    { id: '1', title: 'Ace Clutch', thumbnail: '/thumbnails/highlight1.jpg', src: '/movie.mp4' },
    { id: '2', title: 'Quick Triple Kill', thumbnail: '/thumbnails/highlight2.jpg', src: '/videos/highlight2.mp4' },
    { id: '3', title: 'Sniper Montage', thumbnail: '/thumbnails/highlight3.jpg', src: '/videos/highlight3.mp4' }
  ];
    ...
    <div className="min-h-screen p-8 bg-gradient-to-b from-[#0f172a] to-[#1e293b]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-2">Upload and showcase your best moments</p>
        </div>
        ...
        >
          <div className="flex flex-col items-center justify-center gap-4">
            <div className={`p-6 rounded-full bg-[rgba(96,148,208,0.1)] transition-transform duration-300 ${
